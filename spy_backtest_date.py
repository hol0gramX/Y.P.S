...
def check_call_exit(row): 
    if row['RSI']<55 and row['RSI_SLOPE']<0 and (row['MACD']<0.05 or row['MACDh']<0.05):
...
def check_put_exit(row): 
    if row['RSI']>45 and row['RSI_SLOPE']>0 and (row['MACD']>-0.05 or row['MACDh']>-0.05):
...
if __name__=="__main__":
    backtest("2025-09-25","2025-09-25")
